...
<title>Solicitar Residencia</title>
...
<h2 class="featured-title2">Residencias Profesionales</h2>
    ...
    <fieldset><legend style="font-weight: bold; margin-bottom:40px; margin-left:30%">Solcitud: Carta de presentaci&oacute;n</legend>
		...
		<div>
			...
			<select required name="lstDependencias" id="lstDependencias">
				<option id="otraDependencia" value=""></option>
...
<!--        <label class="formLabel" for="dependencias">Empresa:</label>-->
<!--        -->
<!--        <select name="lstDependencias_old" id="lstDependencias_old" class="formList" onchange="validarDependencia();">-->
<!--        --><?php //while($row_datosDependencia = mysqli_fetch_assoc($datosDependencia)){ ?>
<!--        <option id="dependencias_old" value="--><?php //echo $row_datosDependencia['idDependencia']; ?><!--">--><?php //echo $row_datosDependencia['nomDependencia']; ?><!--</option>-->
<!--        --><?php //}; ?><!-- -->
...
<!--        </select>-->
        ...
        <input name="tipoSolicitud" type="hidden" value="residencia"/>
        ...
        <label class="formLabel" for="proyecto">Proyecto:</label>
   	 	<input required class="textbox" maxlength="150" name="proyecto" type="text" style="text-align:left" id="proyecto" value=""/>  <br />
