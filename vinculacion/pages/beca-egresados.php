...
<title>Solicitar Beca Egresados</title>
...
<h2 class="featured-title2">Beca Servicio Social Egresados</h2>
...
<!--        </select>-->
        ...
        <input name="tipoSolicitud" type="hidden" value="beca-egresados"/>     
        ...
        <label class="formLabel" for="programa">Programa:</label>
   	 	<input required class="textbox" name="programa" type="text" style="text-align:left" id="programa" value=""/>  <br /> 
