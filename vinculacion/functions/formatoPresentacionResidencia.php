...
function RotatedText($x, $y, $txt, $angle)
{
	...
	$pdf->Cell(0,4,'Oficina de Prácticas y Promoción Profesional',0,1,'R');
...
$pdf->Ln(8);
//	$pdf->MultiCell(173,5, 'Queda determinada por un periodo de cuatro meses como tiempo mínimo y seis meses como tiempo máximo, debiendo acumularse un mínimo de 500 y un máximo de 640 horas.',0,'J');
$pdf->MultiCell(173,5, 'Queda determinada por un periodo de cuatro meses como tiempo mínimo y seis meses como tiempo máximo.',0,'J');	$pdf->Ln(4);
...
//$pdf->MultiCell(173,5, 'Es importante hacer de su conocimiento que todos los estudiantes que se encuentran inscritos en esta institución cuentan con un seguro contra accidentes personales con la empresa ASEGURADORA Royal & SunAliance Seguros México S.A. de C.V., según póliza No. 5632 e inscripción en el IMSS.',0,'J');
	...
	//$pdf->MultiCell(173,5, 'Es importante hacer de su conocimiento que todos los estudiantes que se encuentran inscritos en esta institución cuentan con un seguro contra accidentes personales con la empresa',0,'J');
//	$pdf->Write(5,utf8_decode($nombreAseguradora).', según póliza No. '.$polizaAseguradora.' e inscripción en el IMSS.');
	$pdf->SetFont('Arial', 'B', 10);
