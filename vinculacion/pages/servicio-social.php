...
<title>Solicitar Servicio Social</title>
...
<h2 class="featured-title2">Servicio Social</h2>
...
<div class="formSection">
    ...
    <fieldset><legend style="font-weight: bold; margin-bottom:20px; margin-left:30%">Solcitud: Carta de presentaci&oacute;n</legend>    
        ...
        <label class="formLabel" for="telefono">Teléfono (10 digitos):</label>
   	 	<input required name="telefono" maxlength="10" type="text" title="Ej. 6641234578" pattern="[0-9]{10,}" style="text-align:left; margin-left:50px;" id="telefono" value="<?php echo $row_datosAlumno['telefono']; ?>"/>
...
<!--        </select>-->
        ...
        <input name="tipoSolicitud" type="hidden" value="servicio-social"/>     
        ...
        <label class="formLabel" for="telefonoDependencia">Tel&eacute;fono de la dependencia (10 digitos):</label>
		...
		<!-- crb01 quitar fecha inicio y fin de servicio social -->
        ...
        <input required="required" class="fecha" type="text" id="fechaTermino" name="fechaTermino" value=""/>
        <br />
       
		<!--
        <center><img height="40px" width="40px" src="../images/preview.png" title="Vista Previa" class="accion" id="preview" name="preview" onclick="vistaPrevia()"/></center>
        <br />
		-->
...
$(document).ready(
  ...
  function () 
  {
	...
	{
		/** crb01 eliminar fecha de inicio y fecha de fin
		...
		var url = "../functions/preview_formatoPresentacionServicio.php?numSolicitud=00000&nomAlumno="+nomAlumno+"&apPaterno="+apPaterno+"&apMaterno="+apMaterno+"&curp="+curp+"&idAlumno="+idAlumno+"&carrera="+carrera+"&nomDependencia="+nomDependencia+"&programa="+programa;
		window.open(url);
